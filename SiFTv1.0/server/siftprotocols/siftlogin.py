...
class SiFT_LOGIN:
    def __init__(self, mtp):
        ...
        self.delimiter = '\n'
        self.coding = 'utf-8'
        self.time_window_delta = 1_000_000_000
        # --------- STATE ------------
        self.mtp = mtp
    ...
    def handle_login_server(self):
        ...
        time_difference = abs(current_time - int(login_req_struct['timestamp']))
        if time_difference > self.time_window_delta:
            raise SiFT_LOGIN_Error('Timestamp outside of acceptance window')
    ...
    def handle_login_client(self, username, password):
        ...
        try:
            self.mtp.send_msg(self.mtp.type_login_req, msg_payload, login = True)
        except SiFT_MTP_Error as e:
